...
function Assignee({ members, project, issue }) {
    ...
    return (
        ...
        >
            {
                currentAssignee ?
                    <Tooltip title={currentAssignee.fullName}>
                        <Avatar onClick={toggle} {...stringAvatar(currentAssignee?.fullName)} />
                    </Tooltip> :
            ...
            {show && <SelectAssignee setShow={setShow} members={members} handleSelectMember={handleSelectMember} issue={issue} />}
        </div>
    );
}
export default Assignee;

function SelectAssignee({ members, handleSelectMember, issue, setShow }) {
